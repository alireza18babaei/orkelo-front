...
function debug(message) {
  var _a;
  if (((_a = globalThis == null ? void 0 : globalThis.process) == null ? void 0 : _a.env.DEBUG) === "@hwc/retry") {
...
var MAX_TASK_TIMEOUT, MAX_TASK_DELAY, MAX_CONCURRENCY, RetryTask, _retrying, _pending, _working, _timeout, _maxDelay, _timerId, _check, _concurrency, _Retrier_instances, call_fn, processAll_fn, processPending_fn, processQueue_fn, Retrier;
var init_retrier = __esm({
  "node_modules/@humanwhocodes/retry/dist/retrier.js"() {
    ...
    Retrier = class {
       ...
       */
      get retrying() {
        return __privateGet(this, _retrying).length;
      }
      /**
       ...
       */
      get pending() {
        return __privateGet(this, _pending).length;
      }
      /**
       ...
       */
      get working() {
        return __privateGet(this, _working);
      }
      /**
      ...
      retry(fn, { signal } = {}) {
        ...
        __privateGet(this, _pending).push(() => __privateMethod(this, _Retrier_instances, call_fn).call(this, fn, { signal, promise, resolve, reject }));
        __privateMethod(this, _Retrier_instances, processPending_fn).call(this);
        return promise;
      }
    };
    _retrying = new WeakMap();
     ...
     * called successfully.
     */
    call_fn = function(fn, { signal, promise, resolve, reject }) {
      let result;
      try {
        result = fn();
      } catch (error) {
      ...
      __privateWrapper(this, _working)._++;
      promise.finally(() => {
        __privateWrapper(this, _working)._--;
        __privateMethod(this, _Retrier_instances, processPending_fn).call(this);
      }).catch(() => {
      ...
      Promise.resolve(result).then((value) => {
        ...
        __privateGet(this, _retrying).push(task);
     ...
     * @returns {void}
     */
    processPending_fn = function() {
      debug(`Processing pending tasks: ${this.pending} pending, ${this.working} working.`);
      const available = __privateGet(this, _concurrency) - this.working;
      if (available <= 0) {
        return;
      }
      const count = Math.min(this.pending, available);
      for (let i = 0; i < count; i++) {
        const task = __privateGet(this, _pending).shift();
    ...
    processQueue_fn = function() {
      ...
      const processAgain = () => {
        __privateSet(this, _timerId, setTimeout(() => __privateMethod(this, _Retrier_instances, processAll_fn).call(this), 0));
      };
      const task = __privateGet(this, _retrying).shift();
      if (!task) {
      ...
      Promise.resolve(task.fn()).then((result) => {
        ...
        __privateMethod(this, _Retrier_instances, processAll_fn).call(this);
      });
    };
  }
});
...
//# sourceMappingURL=src-HHTBUPUL.js.map
